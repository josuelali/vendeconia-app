...
const getPriceRangeLabel = (value: number) => {
  switch (value) {
    ...
    case 3: return "Precio medio";
    case 4: return "Gama alta";
    case 5: return "Premium";
    default: return "Precio medio";
  }
};
  ...
  return (
    <div>
      <h2 className="text-xl font-bold text-gray-900 mb-1">
        Explora ideas de productos (Demo)
      </h2>
      <p className="text-sm text-gray-500 mb-4">
        Simulación de filtros que usaría una IA para detectar productos interesantes.
      </p>
      ...
      <div className="bg-gray-50 rounded-lg p-4 mb-6">
        ...
        <p className="text-sm text-gray-500 mb-4">
          Estas opciones representan cómo se podrían refinar resultados con IA.
        </p>
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-center space-x-2">
            <Checkbox 
              ...
              onCheckedChange={(checked) =>
                onTrendingOnlyChange(checked as boolean)
              }
            />
            <Label htmlFor="trending-only" className="text-sm text-gray-500">
          ...
          <div className="flex items-center space-x-2">
            <Checkbox 
              ...
              onCheckedChange={(checked) =>
                onFastShippingChange(checked as boolean)
              }
            />
            <Label htmlFor="fast-shipping" className="text-sm text-gray-500">
